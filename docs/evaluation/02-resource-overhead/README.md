...
<br>
<img src="img/resource_overhead_cpu.png" alt="CPU usage by active capture tabs" width="800">
<br>

<img src="img/resource_overhead_ram.png" alt="Memory usage by active capture tabs" width="800">
<br><br>
